...
def test_predict_answer():
    response = client.post("/predict/",
                           ...
                           a few days/weeks 
                           ago and still haven't received it.
                           What should I do in this situation?'''})
    assert response.status_code == 200
    assert response.json() == '''I applied for a visa invitation 
    a few days/weeks ago and still 
    haven't received it. 
    What should I do in this situation?
    There is nothing to worry about. 
    The invitation is issued by the Ministry 
    of Foreign Affairs of the Russian Federation and takes 
    at least 30 days to be prepared. 
    ...
    expiration date of your current visa.
    You will be consulted on the vis
